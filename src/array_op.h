...
void main_blocks_diagonal_multiply(int n, int m, int l, double* a, double* b,
                                   double* d, double* c);
...
void cpy_block_to_matrix_block(double* a, int row, int column, int matrix_size,
                               int n, int m, double* b);

// Copies an off-diagonal block from the packed matrix to a square buffer.
void cpy_matrix_block_to_block(double* a, int row, int column, int matrix_size,
                               int n, int m, double* b);
